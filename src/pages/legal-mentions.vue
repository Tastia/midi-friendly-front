<template>
  <div class="max-w-screen-xl w-full p-8 mx-auto text-base">
    ...
    <p>
      ...
      <strong>Responsable publication</strong> : Tastia –
      pro.tastia@gmail.com<br />
      ...
      <strong>Délégué à la protection des données</strong> : Tastia –
      pro.tastia@gmail.com<br />
    </p>
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>, qui qui
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>, et et
    ...
    <p>
      ...
      l’utilisation du site
      <router-link to="/">https://www.midifriendly.com/</router-link>. Des
    ...
    <p>
      ...
      responsable du traitement des Données Personnelles est : Tastia.
      <router-link to="/">https://www.midifriendly.com/</router-link>est
      représenté par Tastia, son représentant légal
    </p>
    ...
    <p>
      ...
      la connaissance de
      <router-link to="/">https://www.midifriendly.com/</router-link>, celle-ci
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link> prend
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>, résultant
    ...
    <p>
      ...
      mobile de
      <router-link to="/">https://www.midifriendly.com/</router-link>, Twitter,
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>. À tout
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>, et
