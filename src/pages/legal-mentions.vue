<template>
  <div class="max-w-screen-xl w-full p-8 mx-auto text-base">
    <h2>Définitions</h2>
    <p>
      <b>Client :</b> tout professionnel ou personne physique capable au sens des articles 1123 et suivants du
      Code civil, ou personne morale, qui visite le Site objet des présentes conditions générales.<br />
      <b>Prestations et Services :</b>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      met à disposition des Clients :
    </p>

    <p>
      <b>Contenu :</b> Ensemble des éléments constituants l’information présente sur le Site, notamment textes
      – images – vidéos.
    </p>

    <p>
      <b>Informations clients :</b> Ci après dénommé « Information (s) » qui correspondent à l’ensemble des
    ...
    <p>
      <strong>Propriétaire</strong> : Tastia – Paris 75000 Paris<br />

      <strong>Responsable publication</strong> : Tastia – pro.tastia@gmail.com<br />
      Le responsable publication est une personne physique ou une personne morale.<br />
      <strong>Webmaster</strong> : Tastia – https://www.midifriendly.com/<br />
      <strong>Hébergeur</strong> : AWS – 410 Terry Avenue North Seattle<br />
      <strong>Délégué à la protection des données</strong> : Tastia – pro.tastia@gmail.com<br />
    </p>
    ...
    <p>
      ...
      de maintenance technique peut être toutefois décidée par
      <router-link to="/">https://www.midifriendly.com/</router-link>, qui qui qui s’efforcera alors de
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>
      ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur
      mise en ligne.
    </p>
    ...
    <p>
      L’objectif est d’apporter une prestation qui assure le meilleur taux d’accessibilité. L’hébergeur assure
      ...
      ou si les Prestations et Services génèrent un trafic réputé anormal.
    </p>

    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      et l’hébergeur ne pourront être tenus responsables en cas de dysfonctionnement du réseau Internet, des
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      est propriétaire des droits de propriété intellectuelle et détient les droits d’usage sur tous les
      éléments accessibles sur le site internet, notamment les textes, images, graphismes, logos, vidéos,
      icônes et sons. Toute reproduction, représentation, modification, publication, adaptation de tout ou
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      ne pourra être tenu responsable des dommages directs et indirects causés au matériel de l’utilisateur,
      lors de l’accès au site internet
      <router-link to="/">https://www.midifriendly.com/</router-link>, et et résultant soit de l’utilisation
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      ne pourra également être tenu responsable des dommages indirects (tels par exemple qu’une perte de
      marché ou perte d’une chance) consécutifs à l’utilisation du site
      <router-link to="/">https://www.midifriendly.com/</router-link>. Des espaces interactifs (possibilité de
      ...
      qui contreviendrait à la législation applicable en France, en particulier aux dispositions relatives à
      la protection des données. Le cas échéant,
      <router-link to="/">https://www.midifriendly.com/</router-link>
    ...
    <p>
      ...
      : Tastia.
      <router-link to="/">https://www.midifriendly.com/</router-link>est représenté par Tastia, son
      représentant légal
    </p>
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      ne commercialise pas vos données personnelles qui sont donc uniquement utilisées par nécessité ou à des
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>
      par la loi, notamment en matière de conservation ou d’archivage des documents. Enfin, les Utilisateurs
      de
      <router-link to="/">https://www.midifriendly.com/</router-link>
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      s’interdit de traiter, héberger ou transférer les Informations collectées sur ses Clients vers un pays
      situé en dehors de l’Union européenne ou reconnu comme « non adéquat » par la Commission européenne sans
      en informer préalablement le client. Pour autant,
      <router-link to="/">https://www.midifriendly.com/</router-link>
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>, celle-ci devra dans les meilleurs
      délais informer le Client et lui communiquer les mesures de corrections prises. Par ailleurs
      <router-link to="/">https://www.midifriendly.com/</router-link>
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>
      et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à
      son tour tenu de la même obligation de conservation et de modification des données vis à vis de
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link> prend toutes les mesures raisonnables
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>. Cependant,
      <router-link to="/">https://www.midifriendly.com/</router-link>
    ...
    à tout moment désactiver ces cookies et ce gratuitement à partir des possibilités de désactivation qui
    vous sont offertes et rappelées ci-après, sachant que cela peut réduire ou empêcher l’accessibilité à tout
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      est susceptible de traiter les informations de l’Utilisateur concernant sa visite du Site, telles que
      les pages consultées, les recherches effectuées. Ces informations permettent à
      <router-link to="/">https://www.midifriendly.com/</router-link>
    ...
    <p>
      ...
      ne soient pas toutes disponibles.
    </p>
    <p>
      ...
      expérience sur le Site peuvent être limitées. Cela pourrait également être le cas lorsque
      <router-link to="/">https://www.midifriendly.com/</router-link>
      ou l’un de ses prestataires ne peut pas reconnaître, à des fins de compatibilité technique, le type de
      navigateur utilisé par le terminal, les paramètres de langue et d’affichage ou le pays depuis lequel le
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>, résultant (i) du refus de Cookies par
      ...
      de quelle manière l’Utilisateur peut modifier ses souhaits en matière de Cookies.
    </p>
    <p>
      À tout moment, l’Utilisateur peut faire le choix d’exprimer et de modifier ses souhaits en matière de
      Cookies.
      <router-link to="/">https://www.midifriendly.com/</router-link>
      pourra en outre faire appel aux services de prestataires externes pour l’aider à recueillir et traiter
    ...
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>
      ou dans son application mobile et si l’Utilisateur a accepté le dépôt de cookies en poursuivant sa
      navigation sur le Site Internet ou l’application mobile de
      <router-link to="/">https://www.midifriendly.com/</router-link>, Twitter, Facebook, Linkedin et Google
      Plus peuvent également déposer des cookies sur vos terminaux (ordinateur, tablette, téléphone portable).
    </p>
    <p>
      ...
      <router-link to="/">https://www.midifriendly.com/</router-link>. À tout moment, l’Utilisateur peut
    ...
    <p>
      <router-link to="/">https://www.midifriendly.com/</router-link>
      peut employer occasionnellement des balises Internet (également appelées « tags », ou balises d’action,
      ...
      informations correspondantes, y compris l’adresse IP de l’Utilisateur) dans un pays étranger.
    </p>
    ...
    <p>
      ...
      de fois où une page est ouverte et les informations consultées), ainsi que l’utilisation de ce Site par
      l’Utilisateur.
    </p>
    <p>
      ...
      l’attention de
      <router-link to="/">https://www.midifriendly.com/</router-link>, et fournir d’autres services relatifs à
