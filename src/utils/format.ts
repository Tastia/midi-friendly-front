...
export const formatTimeFromNow = (val: string | number) => dayjs(val).fromNow(true);
...
export const formatNullableText = (val: string | null | undefined) => val?.toString() ?? "N/A";
...
export const getTimeDiff = (deadline: string, start?: string, percent?: boolean) => {
